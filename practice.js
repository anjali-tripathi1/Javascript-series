...
// const myArray = ["shaktiman", "doga", "cat"]
// let arr = 0
// while (arr < myArray.length) {
//     console.log(`valus is ${myArray[arr]}`);
//     arr++
// }
...
// const myArray = ["js", "java", "python", "ruby", "cpp"]
...
// myStrings.forEach( (item) => {
//     console.log(item)
// })

const coding = ["javascript", "Java", "python", "cpp", "swift"]
